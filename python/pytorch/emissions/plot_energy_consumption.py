...
# List of CSV files
csv_files = [
    "aggregate_resnet18_cifar100.csv.csv",
    "aggregate_resnet18_fashion.csv.csv",
    "aggregate_resnet18_tiny.csv.csv",
    "aggregate_vgg16_cifar100.csv.csv",
    "aggregate_vgg16_fashion.csv.csv",
    "aggregate_vgg16_tiny.csv.csv",
]
...
for csv_file in csv_files:
    ...
    label = csv_file.replace("aggregate_", "").replace(".csv.csv", "")
    linestyles = {
        "resnet18_cifar100": "-",
        "resnet18_fashion": "--",
        "resnet18_tiny": "-.",
...
plt.title("Energy Consumption per Epoch for Training Phase")
plt.legend()
plt.grid(True)
