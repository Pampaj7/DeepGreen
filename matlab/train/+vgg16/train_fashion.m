...
% >> vgg16.train_fashion('data/fashion_mnist_png','vgg16_fashion','matlab/checkpoints/vgg16_fashion_matlab.mat',30,128);
% 
% Alternatvely, run :
% $ matlab -batch "; vgg16.train_fashion('data/fashion_mnist_png','vgg16_fashion','matlab/checkpoints/vgg16_fashion_matlab.mat',30,128); exit"
%
function train_fashion(datasetDir, emissionFileName, outMat, epochs, batchSize)
    ...
    if nargin<2||isempty(emissionFileName), emissionFileName    = 'vgg16_fashion'; end
    if nargin<3||isempty(outMat),           outMat              = 'matlab/checkpoints/vgg16_fashion_matlab.mat'; end
