...
% >> resnet18.train_cifar100('data/cifar100_png','resnet18_cifar100','matlab/checkpoints/resnet18_cifar100_matlab.mat',30,128);
% 
% Alternatvely, run :
% $ matlab -batch "; resnet18.train_cifar100('data/cifar100_png','resnet18_cifar100','matlab/checkpoints/resnet18_cifar100_matlab.mat',30,128); exit"
%
function train_cifar100(datasetDir, emissionFileName, outMat, epochs, batchSize)
    % --------- default args ---------
